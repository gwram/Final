...
#df_ayer.to_csv(r'C:\Users\GW\Desktop\Python ETL Certus\Data Ops\Monitor_report_diario.csv',mode='a',index=False,header=False)
#df_actualizado = pd.read_csv(r'C:\Users\GW\Desktop\Python ETL Certus\Data Ops\Monitor_report_diario.csv')
#print(df_actualizado)
